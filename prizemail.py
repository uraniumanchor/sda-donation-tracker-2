...
def get_winner_accept_email_template_name():
    return getattr(settings, 'PRIZE_WINNER_ACCEPT_EMAIL_TEMPLATE_NAME', 'default_prize_winner_accept_email_template')
...
""",
            'subject': 'Prize{{ prize_count|pluralize }} {{ prize_count|pluralize:"Has:Have" }} Been Accepted',
...
def get_shipping_email_template_name():
    return getattr(settings, 'PRIZE_SHIPPING_EMAIL_TEMPLATE_NAME', 'default_prize_shipping_email_template')
